...
const SELF_HOSTED_JUDGE0_BASE_URL = "https://judge0.virtusasystems.com";

const AUTHENTICATED_CE_BASE_URL = SELF_HOSTED_JUDGE0_BASE_URL;
const AUTHENTICATED_EXTRA_CE_BASE_URL = SELF_HOSTED_JUDGE0_BASE_URL;

var AUTHENTICATED_BASE_URL = {};
AUTHENTICATED_BASE_URL[CE] = AUTHENTICATED_CE_BASE_URL;
AUTHENTICATED_BASE_URL[EXTRA_CE] = AUTHENTICATED_EXTRA_CE_BASE_URL;

const UNAUTHENTICATED_CE_BASE_URL = SELF_HOSTED_JUDGE0_BASE_URL;
const UNAUTHENTICATED_EXTRA_CE_BASE_URL = SELF_HOSTED_JUDGE0_BASE_URL;
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    console.log("Hey, VSS IDE is open-sourced: https://github.com/judge0/ide. Have fun!");
